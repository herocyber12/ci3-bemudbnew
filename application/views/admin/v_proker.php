            ...
            <div class="row">
              ...
              <div class="card">
                ...
                if($data1['status'] == "Disetujui"){
                  ...
                  echo anchor(base_url('admin/delete_proker/').$data1['id'],'<button type="submit" name="delete" class="btn btn-danger m-2" value="Hapus"><i class="mdi mdi-trash-can"></i>Hapus</button>'); 
                  echo"</td>";
                  ...
                  echo anchor(base_url('admin/konfirmasi_proker/').$data1['id'],'<button type="submit" class="btn btn-success mr-1" name="submit" value="konfirmasi"><i class="mdi mdi-check"></i>Konfirmasi</button>');
                  echo anchor(base_url('admin/tolak_proker/').$data1['id'],'<button type="submit" class="btn btn-warning" name="submit" value="tolak"><i class="mdi mdi-hand-back-left"></i>Tolak </button>');
                  echo anchor(base_url('admin/delete_proker/').$data1['id'],'<button type="submit" name="delete" class="btn btn-danger ml-1" value="Hapus"><i class="mdi mdi-trash-can"></i>Hapus</button>');
                  echo "</div>";
                }
								?>
						</tr>
