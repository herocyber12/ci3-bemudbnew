            ...
            <div class="row">
              <div class="col-lg-12 d-flex grid-margin stretch-card">
				...
				if($data1['status'] == "Diterima"){
                  ...
                  echo anchor(base_url('oprec/delete_calon/').$data1['id_oprec'],'<button type="submit" name="delete" class="btn btn-danger m-2" value="Hapus"><i class="mdi mdi-trash-can"></i>Hapus</button>'); 
                  echo"</td>";
                  ...
                  echo anchor(base_url('oprec/konfirmasi_calon/').$data1['id_oprec'],'<button type="submit" class="btn btn-success mr-1" name="submit" value="konfirmasi"><i class="mdi mdi-check"></i>Terima</button>');
                  echo anchor(base_url('oprec/tolak_calon/').$data1['id_oprec'],'<button type="submit" class="btn btn-warning" name="submit" value="tolak"><i class="mdi mdi-hand-back-left"></i>Tolak</button>');
                  echo anchor(base_url('oprec/delete_calon/').$data1['id_oprec'],'<button type="submit" name="delete" class="btn btn-danger ml-1" value="Hapus"><i class="mdi mdi-trash-can"></i>Hapus</button>');
                  echo "</div>";
                  echo "</td>";
                }
											?>
