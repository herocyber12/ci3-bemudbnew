                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
							...
							<td><?php echo anchor(base_url('pages/absen/delete_absen/').$data1['id_absen'],'<button type="submit" name="delete" class="btn btn-danger m-2" value="Hapus"><i class="mdi mdi-trash-can"></i>Hapus</button>'); ?></td>
                        </tr>
						  <?php
							endforeach;
						  ?>
